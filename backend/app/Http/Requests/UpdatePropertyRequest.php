...
class UpdatePropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'purpose' => 'sometimes|required|in:sale,rent,lease',
            'type' => 'sometimes|required|in:land,house,flat,warehouse,commercial',
            ...
            'locality' => 'sometimes|required|string|max:255',
            ...
            'status' => 'sometimes|required|in:available,under_negotiation,sold,rented,leased,delisted',
