    ...
    <>
      ...
      <div className="bg-white">
        ...
        <section className="relative pt-48 pb-36 px-6 overflow-hidden flex items-center justify-center">
          <div className="absolute inset-0 bg-gradient-to-br from-[#121316]/95 to-[#1A1B20]/95 z-10"></div>
          ...
          <div className="relative z-20 max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight">
              Building Trust, <br/>
              <span className="text-[#C5A059]">Delivering Dreams.</span>
            </h1>
        ...
        <section className="max-w-7xl mx-auto px-6 -mt-16 relative z-30 mb-24 md:mb-32">
          <div className="bg-white rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.06)] border border-gray-100 p-8 lg:p-14">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:divide-x divide-gray-100">
              ...
              <div className="text-center px-4">
                <div className="text-4xl md:text-5xl font-black text-[#C5A059] tracking-tighter mb-2">12</div>
                <div className="text-gray-500 font-semibold text-sm uppercase tracking-wider">Years of Trust</div>
              </div>
              <div className="text-center px-4">
                <div className="text-4xl md:text-5xl font-black text-[#C5A059] tracking-tighter mb-2">4.9</div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <a href="tel:+919995797450" className="text-[#C5A059] font-semibold flex items-center gap-2 hover:underline">
                ...
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <a href="tel:+919995797451" className="text-[#C5A059] font-semibold flex items-center gap-2 hover:underline">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    +91 99957 97451
                  </a>
                </div>
          ...
          <div className="max-w-2xl mx-auto bg-white p-8 md:p-14 rounded-[40px] shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100">
            ...
            {sent ? (
              <div className="text-center py-10">
                <div className="w-20 h-20 bg-[#FAF6EE] text-[#C5A059] rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input required value={form.name} onChange={e => setForm({...form, name: e.target.value})} placeholder="Your full name" className="w-full px-5 py-4 rounded-xl border border-gray-200 focus:border-[#C5A059] focus:ring-2 focus:ring-[#C5A059]/20 outline-none transition-all bg-gray-50 focus:bg-white" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-2">Email Address</label>
                  <input required type="email" value={form.email} onChange={e => setForm({...form, email: e.target.value})} placeholder="you@example.com" className="w-full px-5 py-4 rounded-xl border border-gray-200 focus:border-[#C5A059] focus:ring-2 focus:ring-[#C5A059]/20 outline-none transition-all bg-gray-50 focus:bg-white" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-2">Message</label>
                  <textarea required value={form.message} onChange={e => setForm({...form, message: e.target.value})} placeholder="How can we help you?" className="w-full px-5 py-4 rounded-xl border border-gray-200 focus:border-[#C5A059] focus:ring-2 focus:ring-[#C5A059]/20 outline-none transition-all bg-gray-50 focus:bg-white resize-y min-h-[140px]"></textarea>
                </div>
